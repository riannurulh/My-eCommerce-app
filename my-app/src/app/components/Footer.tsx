export default function Footer() {
  return (
    <footer className="bg-gray-900 p-10 font-[sans-serif] tracking-wide">
        ...
        <div className="mr-20">
          ...
          <ul className="space-y-4">
            <li>
              ...
              >
                At Trendy Finds, we believe in bringing you the latest and most
                stylish products at unbeatable prices. Our carefully curated
                collection ranges from fashion-forward apparel to cutting-edge
                electronics, all designed to fit your lifestyle. We pride
                ourselves on exceptional customer service, ensuring that your
                shopping experience is seamless and enjoyable from start to
                finish.
              </a>
            </li>
          </ul>
      ...
      <p className="text-gray-300 text-sm mt-10">© BELI. All rights reserved.</p>
    </footer>
  );
}
